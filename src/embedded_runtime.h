...
extern const char _runtime_pool_allocator_h[];
extern const size_t _runtime_pool_allocator_h_len;
extern const char _runtime_pool_allocator_c[];
extern const size_t _runtime_pool_allocator_c_len;
